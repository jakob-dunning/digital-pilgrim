...
class PilgrimRepository
{
    ...
    {
        return new Pilgrim(
            UrlQueue::createFromArray($this->get('scraperQueue')),
            Url::createFromString($this->get('currentDomain')),
            UrlCollection::createFromArray($this->get('scraperHistory')),
            UrlCollection::createFromArray($this->get('destinations')),
            UrlCollection::createFromArray($this->get('domainHistory'))
        );
    }
